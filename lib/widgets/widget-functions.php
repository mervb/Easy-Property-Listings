<?php
	...
	function epl_search_widget_fields_frontend( $post_type = '', $property_status = '' ) {
		...
		if ( in_array( $post_type, apply_filters( 'epl_core_rental_post_types', array(
					'rental',
					'holiday_rental'
				) ) ) ) {
	 ...
	 * @param  array    $data      That contains epl search key value pairs and if it's empty it will replace by
	 *                             $_REQUEST
